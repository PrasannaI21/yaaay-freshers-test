...
public class Internships extends BaseTest{
	...
	@BeforeMethod
	public void setupInternships() throws IOException
	{
		navigateTo("/");
	...
	public void verifyIntPageTitle()
	{
		profilePreview.clickAddInternship();
	...
	public void verifyIntPlaceholder()
	{
		profilePreview.clickAddInternship();
	...
	public void verifyIntStartMonthRequired()
	{
		profilePreview.clickAddInternship();
	...
	public void verifyIntStartYearRequired()
	{
		profilePreview.clickAddInternship();
	...
	public void verifyIntEndMonthRequired()
	{
		profilePreview.clickAddInternship();
		internships.selectStartMonth("October");
		internships.selectStartYear("1991");
